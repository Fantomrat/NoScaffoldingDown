...
Rename the `ru.fantomrat.scaffoldingnodown` package in
...
* **Shared code** goes in `ru.fantomrat.scaffoldingnodown` (no platform dependencies)
* **Platform-specific code** goes in `ru.fantomrat.scaffoldingnodown.platform.{fabric|neoforge|forge}`
